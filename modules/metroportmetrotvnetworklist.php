...
try {
    ...
    $services = $metrotv->GetMetroTvNetworkList();
    $result = ApiInit::Success($services, 'Lista podsieci MetroTV pobrana pomyślnie.');
...
$SMARTY->display('metroportmetrotvnetworklist.html');
